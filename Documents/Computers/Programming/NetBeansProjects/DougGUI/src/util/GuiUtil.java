...
public final class GuiUtil {
     ...
     * @param x The x-position on the gridbag layout
     * @param y The y-position on the gridbag layout
     * @param headerWidth The width of the header
     * @param returnWidth The width to return the gridbag constraint to
     */
