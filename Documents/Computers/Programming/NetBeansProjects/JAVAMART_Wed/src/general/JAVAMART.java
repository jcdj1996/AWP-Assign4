...
public class JAVAMART 
{
    ...
    public static void main(String[] args)
    {
        ...
        //employee test data
        SalesPlusCommissionEmployee emp = new  SalesPlusCommissionEmployee(
        ...
        String className = empList.get(0).getClass().getName();
        System.out.println(className);
        className = empList.get(1).getClass().getName();
        System.out.println(className);
        //emp testing 
