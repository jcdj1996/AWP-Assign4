...
public class EntityInformation {
    ...
    private static final String[] PROVINCES_SHORT = {
        "AB", "BC", "MN", "NFLD", "NB", "NS", "NU", "NWT", "ON", "PEI", "QC", "SK", "YK"
    };

    private static final String[] PROVINCES_LONG = {
        "Alberta", "British Columnbia", "Manitoba", "Newfoundland and Labrador", "New Brunswick",
    ...
    public static final boolean checkEmail(String email) {
        return Check.isRegex(email,
                ...
                new String[]{"You need to have a valid email",
